...
static const PalRGB pal_src[NUM_PALETTES][4] = {
    ...
    {{200,210,255},{140,155,220},{ 80, 95,160},{ 30, 40, 90}}, /* Midnight */
    {{200,160,255},{150,110,220},{100, 60,160},{ 55, 25,100}}, /* Grape */
    {{220,160,120},{170,110, 70},{120, 65, 35},{ 70, 35, 15}}, /* Rust */
    {{255,200,160},{220,150,100},{170, 90, 50},{100, 45, 15}}, /* Copper */
    {{160,180,220},{110,130,190},{ 65, 85,140},{ 30, 45, 90}}, /* Denim */
    {{255,240,100},{240,200, 40},{190,150, 15},{110, 85,  0}}, /* Sunflower */
    {{ 80,255,255},{ 40,210,240},{ 20,140,200},{ 10, 70,120}}, /* Electric */
    {{255,100,120},{190, 55, 75},{110, 25, 45},{ 55, 10, 20}}, /* Blood Moon */
  /* Multicolor — 4 matizes distintos por paleta (claro → escuro) */
    {{255,240,120},{120,255,180},{255,150, 90},{ 90, 80,200}}, /* Rainbow */
    {{255,220,240},{200,255,220},{200,210,255},{130, 90,170}}, /* Pastel Quad */
    {{255,255, 80},{  0,255,240},{255,  0,200},{ 80,  0,160}}, /* Arcade */
    {{255,200,255},{140,180,255},{ 80,120,220},{ 40, 30,100}}, /* Cosmos */
    {{255,220,240},{255,140,180},{200, 60,100},{ 80, 20, 80}}, /* Kirby */
    {{180,220,255},{100,210,100},{220,140, 80},{ 60, 40, 30}}, /* Mario */
    {{255,240,160},{120,200, 80},{200,160, 60},{ 50, 80, 50}}, /* Zelda */
    {{255,240,220},{255,120,120},{120,160,255},{ 60, 30, 90}}, /* Poke */
    {{255,240,100},{255,100,100},{100,220,100},{120, 60,200}}, /* Fruit */
    {{255,240,200},{255,120, 60},{ 80,160,255},{ 20, 40,120}}, /* Fire Ice */
    {{255,255,160},{ 80,255,220},{255,120,200},{ 40,140, 70}}, /* Tropical */
    {{255,200,240},{180,140,255},{100,180,255},{ 50, 50,140}}, /* Berry GBC */
    {{255,220,180},{140,220,160},{100,180,220},{ 40, 60,100}}, /* Links */
    {{255,180,255},{200,120,255},{140, 80,210},{ 70, 40,120}}, /* Vaporwave */
    {{255, 60,180},{180, 40,255},{ 60,200,255},{ 30, 20, 80}}, /* Synthwave */
    {{255,  0,255},{  0,255,255},{255,255,  0},{255,  0,  0}}, /* Neon */
    {{120,200,255},{ 80,200,120},{200,120, 80},{ 60, 40,120}}, /* Duck Hunt */
    {{180,255,220},{140,200,255},{200,140,255},{ 50, 60,100}}, /* Aurora */
    {{180,220,200},{120,180,150},{ 70,120, 90},{ 35, 70, 45}}, /* Patina */
    {{210,255,  0},{100,220,180},{255,140,  0},{ 80, 60,180}}, /* Toxic Pop */
    {{255,140,255},{210, 90,210},{150, 50,150},{ 90, 15, 90}}, /* Magenta */
    {{255,200,120},{120,220,255},{220,100,180},{ 60, 40, 90}}, /* Candy */
    {{255,180,100},{100,255,200},{200,100,255},{ 80, 40,120}}, /* Sunset Wave */
    {{200,255,255},{255,200,120},{255,120,180},{ 60, 80,160}}, /* Parrot */
    {{255,240,200},{180,255,140},{140,180,255},{ 60, 50,120}}, /* Spring */
    {{255,220,160},{255,160,200},{160,200,255},{ 70, 50,130}}, /* Cotton Candy */
    {{240,255,180},{180,255,220},{220,180,255},{ 80,100,160}}, /* Opal */
    {{255,255,200},{255,180,120},{120,200,255},{ 50, 50,130}}, /* Beach */
    {{255,200,180},{180,255,200},{180,180,255},{100, 80,160}}, /* Watercolor */
};
